...
from numpy._typing import (  # Arrays; DTypes; Shapes; Scalars; `number` precision; NOTE: Do not remove the extended precision bit-types even if seemingly unused;; they're used by the mypy plugin; Character codes; Ufuncs
    ...
    _ArrayLikeComplex128_co, _ArrayLikeComplex_co, _ArrayLikeDT64_co,
    _ArrayLikeFloat64_co, _ArrayLikeFloat_co, _ArrayLikeInt, _ArrayLikeInt_co,
    _ArrayLikeNumber_co, _ArrayLikeObject_co, _ArrayLikeTD64_co,
    ...
    _DT64Codes, _DTypeLike, _DTypeLikeVoid, _FiniteNestedSequence,
    _FlexibleCodes, _Float16Codes, _Float32Codes, _Float64Codes,
    _FloatingCodes, _FloatLike_co, _GenericCodes, _GUFunc_Nin2_Nout1,
    ...
    _NBitShort, _NBitSingle, _NestedSequence, _NumberCodes, _NumberLike_co,
    _ObjectCodes, _ScalarLike_co, _Shape, _ShapeLike, _ShortCodes,
    _SignedIntegerCodes, _SingleCodes, _StrCodes, _StringCodes, _SupportsArray,
    _TD64Codes, _TD64Like_co, _UByteCodes, _UFunc_Nin1_Nout1,
...
from numpy.lib._shape_base_impl import (apply_along_axis, apply_over_axes,
                                        ...
                                        put_along_axis, split, take_along_axis,
                                        tile, vsplit)
